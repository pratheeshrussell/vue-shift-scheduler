...
This is a simple Vue Shift scheduler component created by editing the **vue-simple-calendar** package that is a flexible, themeable, lightweight calendar component for Vue that supports multi-day scheduled items.
